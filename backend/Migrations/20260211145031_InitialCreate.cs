        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    emp_id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    signature_data = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dep_head = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    dep_kode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    div_id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    dep_initial = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    modify_by = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    div_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    div_name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    div_status = table.Column<int>(type: "int", nullable: true),
                    plant_id = table.Column<int>(type: "int", nullable: true),
                    div_head = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    div_kode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    div_initial = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    create_date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    create_by = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    modify_date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    modify_by = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    item_num = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    kat_id = table.Column<int>(type: "int", nullable: false),
                    item_status = table.Column<int>(type: "int", nullable: true),
                    item_desc = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    series_id = table.Column<int>(type: "int", nullable: true),
                    item_na = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    item_asam = table.Column<int>(type: "int", nullable: true),
                    item_ds = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    item_lot = table.Column<int>(type: "int", nullable: true),
                    item_keterangan = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    item_tgl = table.Column<DateTime>(type: "datetime2", nullable: true),
                    creadate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    creaby = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    modidate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    modiby = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    jopr_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    jopr_name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    jopr_status = table.Column<int>(type: "int", nullable: true),
                    sec_id = table.Column<int>(type: "int", nullable: true),
                    jopr_alias = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    create_date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    create_by = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    modify_date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    modify_by = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    kat_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    kat_name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    kat_status = table.Column<int>(type: "int", nullable: true),
                    item_pch = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    line_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    line_name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    line_status = table.Column<int>(type: "int", nullable: true),
                    sec_id = table.Column<int>(type: "int", nullable: true),
                    crea_date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    crea_by = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    modi_by = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    modi_date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    work_center = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    line_ket = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lgp_leader = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    lgp_kasubsie = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    mold_code = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    mold_description = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    item_num = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    mold_sts = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    created_by = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    created_date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    modif_by = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    modif_date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    mold_status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    mt_name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    mt_status = table.Column<int>(type: "int", nullable: true),
                    mt_createBy = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    mt_createDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    mt_modifBy = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    mt_modifDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    klasifikasi = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    group_id = table.Column<int>(type: "int", nullable: true),
                    userKasie_id = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    plant_name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    sec_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    sec_name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    dep_id = table.Column<int>(type: "int", nullable: true),
                    sec_status = table.Column<int>(type: "int", nullable: true),
                    sec_head = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    sec_kode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    series_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    series_name = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    created_by = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    created_date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    modif_by = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    modif_date = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    shift_start = table.Column<TimeSpan>(type: "time", nullable: true),
                    shift_end = table.Column<TimeSpan>(type: "time", nullable: true),
                    shift_status = table.Column<int>(type: "int", nullable: true),
                    shift_plan = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    shift_code = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    user_npk = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    user_nama = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    user_namafull = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    user_createBy = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    user_modifBy = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    user_createDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    user_modifDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    user_status = table.Column<int>(type: "int", nullable: true),
                    emp_id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    dept_id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    userKasie_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    sec_id = table.Column<int>(type: "int", nullable: false),
                    kasie_emp_id = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    create_date = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Full_Name = table.Column<string>(type: "nvarchar(302)", maxLength: 302, nullable: true),
                    ...
                    pos_name_id = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    item_key = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    label = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    type = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    visual_standard = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    numeric_std_key = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    fixed_standard = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    conditional_label = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    form_id = table.Column<int>(type: "int", nullable: false),
                    column_key = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    operator_emp_id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    leader_emp_id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    kasubsie_emp_id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    kasie_emp_id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
